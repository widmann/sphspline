% pop_plotsserpmap() - Plot 2D map using spherical spline interpolation
%
% Usage:
...
if nargin < 2
    ...
    uilist = {{'style' 'text' 'string' 'Plot:'} ...
              ...
              {'style' 'text' 'string' 'Window start times (s)/ components:'} ...
              {'style' 'edit' 'string' ''} ...
              {'style' 'text' 'string' 'Window end times (s):'} ...
              {'style' 'edit' 'string' ''} ...
              {'style' 'text' 'string' 'Smoothing {default 0}:'} ...
              {'style' 'edit' 'string' ''} ...
              {'style' 'text' 'string' 'Projection:'} ...
              {'style' 'popupmenu' 'string' {Proj.name} 'value' 1}};
    result = inputgui(uigeom, uilist, 'pophelp(''pop_plot2dmap'')', 'Plot 2D map -- pop_plot2dmap()');
